...
if importlib.util.find_spec("polars") is not None:
    ...
    class PolarsDataFrameSerializer(Serializer[Any]):
        ...
        def write(obj: Any, directory: Path) -> Mapping[str, Any]:
            ...
            with translate_errors("Could not serialize the Polars DataFrame", (OSError, pl.exceptions.PolarsError)):
        ...
        def read(directory: Path, *, meta: Mapping[str, Any]) -> Any:  # noqa: ARG004
            ...
            with translate_errors("Could not deserialize the Polars DataFrame", (OSError, pl.exceptions.PolarsError)):
    ...
    class PolarsSeriesSerializer(Serializer[Any]):
        ...
        def write(obj: Any, directory: Path) -> Mapping[str, Any]:
            ...
            with translate_errors("Could not serialize the Polars Series", (OSError, pl.exceptions.PolarsError)):
                df = obj.to_frame()
        ...
        def read(directory: Path, *, meta: Mapping[str, Any]) -> Any:
            ...
            with translate_errors("Could not deserialize the Polars Series", (OSError, pl.exceptions.PolarsError)):
